...
**If you encounter 504 bad request error please wait and check your container log your container maybe still download and parsing the map data (we download the entire map of Cambodia so It will took quite a bit between 30 minutes to 1 hour depend on your server)**
